# Generated by Django 4.1.13 on 2024-11-24 01:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dvt', models.CharField(choices=[('Cái', 'Cái'), ('Bịch', 'Bịch')], default='Cái', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vitricongviec', models.CharField(choices=[('Nhân viên phục vụ', 'Nhân viên phục vụ'), ('Nhân viên pha chế', 'Nhân viên pha chế'), ('Nhân viên kho', 'Nhân viên kho'), ('Quản lý', 'Quản lý')], default='Nhân viên phục vụ', max_length=30)),
                ('trangthai', models.CharField(choices=[('Nghỉ làm', 'Nghỉ làm'), ('Đang làm', 'Đang làm')], default='Đang làm', max_length=20)),
            ],
            options={
                'db_table': 'nhanvien',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loaitb', models.CharField(choices=[('Thiết bị pha chế', 'Thiết bị pha chế'), ('Thiết bị quản lý', 'Thiết bị quản lý'), ('Thiết bị lưu trữ', 'Thiết bị lưu trữ')], default='Thiết bị pha chế', max_length=20)),
                ('soluong', models.FloatField()),
                ('tinhtrang', models.CharField(choices=[('Tốt', 'Tốt'), ('Không tốt', 'Không tốt')], default='Tốt', max_length=20)),
                ('ngaymua', models.DateField()),
                ('giamua', models.FloatField()),
                ('tonggia', models.FloatField(max_length=30)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dvt', models.CharField(choices=[('Cái', 'Cái'), ('KG', 'KG'), ('Bịch', 'Bịch')], default='Cái', max_length=10)),
                ('soluong', models.FloatField()),
